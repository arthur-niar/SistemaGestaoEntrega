// Minimal frontend JS to open modals and POST to the gateway
...
function getBase(){ return $('gatewayUrl').value.replace(/\/$/, '') }
...
$('openEntregador').addEventListener('click', ()=> openModal('modalEntregador'))
$('openPedido').addEventListener('click', ()=> openModal('modalPedido'))
$('openPedidoTipo').addEventListener('click', ()=> openModal('modalPedidoTipo'))
